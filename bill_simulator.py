...
def gpt_simulate(action_text):
    ...
    "- Once chamber_progress ≥80 and support ≥ threshold, the next procedural action "
    "(e.g., scheduling, floor debate, or final vote) **must advance progress to 100.**\n"
    "- Never output zero progress when support ≥ threshold.\n"
    "- Apply numeric increments *strictly*, even if the narrative tone implies slowdown.\n\n"
