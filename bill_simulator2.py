...
def gpt_simulate(action_text):
    ...
    system_prompt = (
        ...
        "- This refers to the party breakdown IN CONGRESS (e.g., 218D vs 217R in the House), NOT the member's home district.\n"
        "- Congressional support = support from fellow legislators in the chamber.\n"
        "- Bills aligned with the majority party's priorities gain support from party members. Opposition party resists.\n"
        "- Example: A Democratic gun control bill in a Democratic-controlled House gains support from Democratic colleagues, regardless of the member's district lean.\n"
        ...
        "- This refers to the partisan lean of the member's HOME DISTRICT/STATE (e.g., R+5, D+10, EVEN), NOT the chamber.\n"
        "- Public approval = approval from voters back home, not from fellow legislators.\n"
        ...
        "**CRITICAL: Chamber composition and district composition are DIFFERENT. A Democrat in an R+5 district serving in a Democratic House will gain support from Democratic colleagues (chamber) while losing approval from Republican-leaning voters (district).**\n"
        "\n"
